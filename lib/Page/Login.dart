                                ...
                                AppButton(
                                    ...
                                    onTap: () {
                                      if(emailController.value.text.isEmpty || passwordController.value.text.isEmpty){
                                        AlertFail("Lengkapi Username Password !!");
                                      }else{
                                        if(emailController.value.text == "admin" && passwordController.value.text == "admin"){
                                          IndextAdmin().launch(context);
                                        }else if(emailController.value.text == "peserta" && passwordController.value.text == "peserta"){
                                          IndexUser().launch(context);
                                        }else{
                                          AlertFail("Username Password Salah !!");
                                        }
                                      }
